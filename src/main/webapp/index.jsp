...
<div id="container">
    ...
    <ul id="mainlinks">
      ...
      <li><a href="<c:url value="/sample/photos"/>">sparklr pics</a></li>
      <li><a href="<c:url value="/facebook/info"/>">facebook frienjjjdsss</a></li>
    </ul>
  ...
  <div id="content">
    ...
    <authz:authorize ifAllGranted="ROLE_USER">
      <p><a href="<c:url value="/sample/photos"/>">View my Sparklr photos</a></p>
    </authz:authorize>
